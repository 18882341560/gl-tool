...
public class ResResult<D> implements Serializable {
     ...
     * 成功
     */
    public static<D> ResResult success(D data) {
     ...
     * 成功
     */
    public static<D> ResResult success(String msg, D data) {
     ...
     * 失败
     */
    public static ResResult fail(ResCode resCode) {
     ...
     * 失败
     */
    public static ResResult fail(ResCode resCode, String msg) {
        return response(resCode, msg, null);
    }
    /**
     * 响应
     */
    public static<D> ResResult response(ResCode resCode, String msg, D data) {
